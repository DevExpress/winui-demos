...
namespace ChartsDemo {
    public sealed partial class DashboardDemoModule : DemoModuleView {
        ...
        public static readonly DependencyProperty ViewModelProperty =
            DependencyProperty.Register("ViewModel", typeof(DashboardViewModel), typeof(DashboardViewModel), new PropertyMetadata(null));
        ...
        void OnLoaded(object sender, RoutedEventArgs e) {
            DashboardViewModel viewModel = layoutRoot.DataContext as DashboardViewModel;
            if (viewModel != null) {
                viewModel.SelectedCountry = viewModel.Countries.LastOrDefault();
            }            
        }
