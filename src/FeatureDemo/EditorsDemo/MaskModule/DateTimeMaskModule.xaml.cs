...
namespace EditorsDemo {
    public class DateTimeMaskViewModel : ViewModelBase {
        public TextEdit FocusedEditor {
            get { return GetProperty<TextEdit>(); }
            set { SetProperty(value, OnFocusedEditorChanged); }
        }
        public TextInputMaskSettings TextInputSettings {
            get { return GetProperty<TextInputMaskSettings>(); }
            private set { SetProperty(value); }
        }
        public string Mask {
            get { return GetProperty<string>(); }
            set { SetProperty(value, OnMaskChanged); }
        }
    ...
    public sealed partial class DateTimeMaskModule : DemoSubModuleView {
        public DateTimeMaskModule() {
            ...
            var viewModel = DataContext as DateTimeMaskViewModel;
