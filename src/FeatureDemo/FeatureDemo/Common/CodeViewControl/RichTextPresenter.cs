...
namespace FeatureDemo.Common.Internal {
    ...
    public class RichTextPresenter : Control, IRichTextPresenter {
        public static readonly DependencyProperty TextWrappingProperty = DependencyProperty.Register(nameof(TextWrapping), typeof(TextWrapping), typeof(RichTextPresenter), new PropertyMetadata(TextWrapping.Wrap));
